...
out_dir = "C://Users//adcha//Desktop//output//DRS_Project_Event_based_vision//Generate_Events//Generate_Events_Resized_Data//Non_Flash_Events_withnoise//"
    ...
    for x2 in first_sub_path:
        ...
        for x3 in second_sub_path:
            ...
            for x4 in third_sub_path:
                ...
                max_frames = min(max_frames,len(fourth_sub_path))
                
                #print(len(fourth_sub_path))
                ...
                for x5 in fourth_sub_path:
                    ...
                    # noise_img = sp_noise(image,0.004)#0.004, 0.065, 0.009, 0.115
